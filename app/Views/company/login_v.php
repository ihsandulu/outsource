...
<head>
    ...
    <style>
        body, .container-login100{
            background-image: url("<?=base_url("images/backgroundperusahaan.png");?>") !important;
        ...
        .login100-form-title{background-color:blue;}
        .login100-form-btn{ background-color: #3131FF;}
    </style>
</head>
