                            ...
                            <div class="text-center mb-3">
                                <div class="row tengahfixed">
                                    ...
                                    <div class="col-6 text-left">
                                        ...
                                        <br />
                                        <br />
                                        <a class="btn btn-warning mb-2" href="<?=base_url("login-pekerja");?>">Login</a>
                        ...
                        <div class="col-lg-6">                        
                            <form data-sb-form-api-token="API_TOKEN" method="post" action="">
                                ...
                                <div class="form-floating mb-3">
                                    <input onkeyup="cek()" minlength="8" required class="form-control" id="user_password" name="user_password" type="text" placeholder="Enter your password"  />
                                ...
                                <input type="hidden" id="user_id" name="user_id" value="<?=$this->request->uri->getSegment(2);?>"/>
