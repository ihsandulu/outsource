                            ...
                            <form class="form-horizontal" method="post" enctype="multipart/form-data"> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        if($page=="loker"){
                                            $builder->notLike("category_name","produk","both");
                                        }else{
                                            $builder->like("category_name","produk","both");
                                        }
                                        $category = $builder
                        ...
                        <div class="table-responsive m-t-40">
                            <table id="example23" class="display nowrap table table-hover  table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    if($page=="loker"){
                                        $builder->notLike("category.category_name","produk","both");
                                    }else{
                                        $builder->like("category.category_name","produk","both");
                                    }
                                    $usr=$builder
                                    ...
                                    foreach ($usr->getResult() as $usr) { 
                                        ...
                                        <tr class="<?=$onoff[$usr->product_onoff];?>">
                                            ...
                                            <?php if($page=="produk"){?>
                                                ...
                                                ?>
                                                <td class="text-right"><?= ($usr->product_type==0)?number_format($limit,0,".",","):""; ?></td>
                                                <td class="text-right"><?= ($usr->product_type==0)?number_format($stock,0,".",","):""; ?></td>
                                                <td class="text-<?=$alstock;?>"><?=$salstock;?></td>
                                                <td class="text-right"><?= ($usr->product_type==0)?number_format($buy,0,".",","):""; ?></td>
                                            <?php }?>
                                            <td class="text-right"><?= number_format($sell,0,".",","); ?></td>
                                            
                                            <?php if($page=="produk"){?>
                                            <td class="text-right"><?= number_format($margin,0,".",","); ?></td>
                                            <td>
                                                <?php if($usr->product_durasi>0){?>
